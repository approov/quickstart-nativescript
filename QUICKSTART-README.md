...
* [`Xcode`](https://developer.apple.com/xcode/) if you would like to build the iOS samples (version 11.0 used in this guide) and a real iOS device since the Approov SDK allows using a simulator but will ONLY authenticate a real iOS device
* [`NativeScript`](https://docs.nativescript.org/) either version 6 or 7 (6.7.5 and 7.2.0 used in this guide)
